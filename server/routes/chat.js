...
// Senior Agent role: escalate to a senior, team-only notes, team view.
router.post("/conversations/:id/escalate", requireAuth, requireSupportOrAdmin, escalateConversation);
